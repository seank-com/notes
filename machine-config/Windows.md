...
12. Remove paths from system settings
...
13. Launch Windows Terminal click down caret and select Settings then click 'Open JSON file'
...
14. create ```~/.gitmessage``` and edit in code as follows
...
15. Launch the Windows Terminal and from Ubuntudev window from the shortcut
...
16. Goto [Github ssh settings](https://github.com/settings/ssh)
  - Click New SSH key
...
19. Install [Beyond Compare](https://www.scootersoftware.com/download.php) and follow directions for [configuring](https://www.scootersoftware.com/support.php?zz=kb_vcs#gitwindows) From your Dev shell

...
7. Goto [wslinstall](https://aka.ms/wslinstall) and follow instructions to install and configure your favorite linux shell
...
11. Launch Windows Terminal click down caret and select Settings then click 'Open JSON file'
...
12. create ```~/.gitmessage``` and edit in code as follows
...
13. Launch the Windows Terminal and from Ubuntudev window from the shortcut
...
17. Install [Beyond Compare](https://www.scootersoftware.com/download.php) and follow directions for [configuring](https://www.scootersoftware.com/support.php?zz=kb_vcs#gitwindows) From your Dev shell
